...
export interface BriefPreview {
  ...
  // New fields for catalog card preview
...
const TOPIC_KEYWORDS: Record<string, string> = {
  ...
  university: 'academic', exam: 'academic', doctor: 'healthcare', hospital: 'healthcare',
};
...
function countCharacters(brief: string): number {
  const l = brief.toLowerCase();
  const roles = ['manager', 'director', 'interviewer', 'barista', 'customer', 'agent', 'landlord', 'colleague', 'boss', 'receptionist', 'doctor', 'nurse', 'teacher', 'waiter', 'client'];
