    ...
    <div className="catalog-card-wrap">
      ...
      <div className="catalog-card">
        ...
        <div className="card-body">
          <div className="card-meta-row">
            <span className="card-agent-count">
              {preview.suggestedCharacterCount} AGENTS
            </span>
            {preview.estimatedDurationMin > 0 && (
              <span className="card-duration">
                ~{preview.estimatedDurationMin} MIN
              </span>
            )}
          </div>
          ...
          {preview.setting && (
            <div className="card-setting-chip">
              {preview.setting.toUpperCase()}
            </div>
          )}
      ...
      <div className="preview-below-section">
        ...
        <p className="confidence-hint">
          {getConfidenceHint(preview.confidence ?? 0)}
        </p>
      </div>
