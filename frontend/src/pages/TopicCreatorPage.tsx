...
export default function TopicCreatorPage() {
  ...
  const handleSave = async (publish = false) => {
    ...
    try {
      ...
      setGlobalError(axiosErr.response?.data?.detail || 'Failed to save topic. Please try again.');
    } finally {
      setSaving(false);
    }
  };
          ...
          <Section title="Basic Information" icon="📝">
            ...
            >
              <textarea
                ...
                placeholder="Provide detailed background information about the topic domain. This becomes part of each character's knowledge base..."
                rows={6}
    ...
    <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-5">
      ...
      <FormField label="Persona" description="How this character thinks and speaks" error={errors[`char_${index}_persona`]}>
        <textarea
          ...
          placeholder="Describe their personality, speaking style, expertise, and how they engage in conversation..."
          rows={3}
      ...
      <FormField label="Bias & Perception" description="Hidden communication tendencies (not shown to learner)">
        <textarea
          ...
          placeholder="Describe subtle biases or conversational tendencies — e.g. prefers data-driven arguments, tends to challenge emotional reasoning..."
          rows={2}
          className={inputClass()}
        />
      </FormField>
