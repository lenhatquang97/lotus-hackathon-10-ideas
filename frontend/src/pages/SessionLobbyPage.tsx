...
export default function SessionLobbyPage() {
    ...
    if (!topic)
        return (
            <div
                className="min-h-screen flex items-center justify-center meta"
            ...
            <div className="w-full max-w-[560px]">
                ...
                <div className="flex items-center gap-4 mb-5">
                    ...
                    {(topic.difficulty_levels || []).map((l) => (
                        <span
                            key={l}
                            className="meta ml-auto px-2 py-0.5 border"
                            style={{
                                fontSize: "10px",
                ...
                <h1
                    className="font-display text-[40px] font-semibold leading-[1.1] mb-4"
                ...
                {micOk && (
                    <p
                        className="text-center meta mb-3"
                ...
                <button
                    onClick={() => navigate(`/world/${sessionId}`)}
                    disabled={!micOk}
